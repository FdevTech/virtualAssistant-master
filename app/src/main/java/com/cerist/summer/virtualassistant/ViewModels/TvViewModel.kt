        ...
        compositeDisposable.add(
                Observable.just(Unit)
                        ...
                        .subscribe(mTvPowerState::postValue) {
                            Log.d(TAG,"error while reading the tv state ${it.message}")
        ...
        compositeDisposable.add(
                Observable.just(Unit)
                        ...
                        .subscribe(mTvVolumeLevel::postValue) {
                            Log.d(TAG,"error while reading the tv volume ${it.message}")
                            mBluetoothErrorStatus.postValue(Status.OPERATION_ERROR)
                        }
    ...
    fun setTvPowerState(state:BroadLinkProfile.TvProfile.State) {
        compositeDisposable.add(
                Observable.just(state)
                        ...
                        .subscribe(mTvPowerState::postValue) {
                            Log.d(TAG,"error while setting the tv state ${it.message}")
                            mBluetoothErrorStatus.postValue(Status.OPERATION_ERROR)
                        })
    }
    ...
    fun setTvVolumeLevel(level:Int) {
        compositeDisposable.add(
                Observable.just(level)
                        ...
                        .subscribe(mTvVolumeLevel::postValue) {
                            Log.d(TAG,"error while setting the tv volume ${it.message}")
                            mBluetoothErrorStatus.postValue(Status.OPERATION_ERROR)
                        })
    }
        ...
        compositeDisposable.add(
                Observable.just(time)
                        ...
                        .subscribe(mTvTimer::postValue) {
                            Log.d(TAG,"error while setting the tv timer ${it.message}")
                            mBluetoothErrorStatus.postValue(Status.OPERATION_ERROR)
                        })
    }
